...
class SlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slot" do
    assert_difference('Slot.count') do
      post slots_url, params: { slot: { description: @slot.description, speaker: @slot.speaker, topic: @slot.topic } }
    end
  ...
  test "should update slot" do
    patch slot_url(@slot), params: { slot: { description: @slot.description, speaker: @slot.speaker, topic: @slot.topic } }
